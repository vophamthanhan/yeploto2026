                ...
                <AnimatePresence mode="popLayout">
                  {selectedNumbers.map((num, index) => (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="w-[104px] h-[104px] md:w-[125px] md:h-[125px] lg:w-[150px] lg:h-[150px] rounded-full flex items-center justify-center flex-shrink-0 cursor-pointer"
                      style={{
                    ...
                    >
                      <span 
                        className="text-red-900 font-bold text-3xl md:text-4xl lg:text-5xl"
